...
const generateTokens = async (user) => {
    try {
        ...
        const accessToken = jwt.sign(payload, accessTokenSecret, { expiresIn: ACCESS_EXPIRES_IN });
        const refreshToken = jwt.sign(payload, refreshTokenSecret, { expiresIn: REFRESH_EXPIRES_IN });
